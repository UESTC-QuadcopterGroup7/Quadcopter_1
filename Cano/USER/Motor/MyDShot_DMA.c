...
{
    if (stream == DMA1_Stream7) return DMA_FLAG_TCIF7;
...
static const DShotDMAChannel_t dmaChannels[4] = {
    {DMA2_Stream6, DMA_Channel_6, &TIM1->CCR1, TIM1, TIM_DMA_CC1}, // M1
    {DMA2_Stream6, DMA_Channel_6, &TIM1->CCR2, TIM1, TIM_DMA_CC2}, // M2
    {DMA2_Stream6, DMA_Channel_6, &TIM1->CCR3, TIM1, TIM_DMA_CC3}, // M3
    {DMA1_Stream7, DMA_Channel_5, &TIM3->CCR3, TIM3, TIM_DMA_CC3}, // M4
};
...
static void DShot_DMA_Config(const DShotDMAChannel_t *cfg, uint16_t *buffer, uint32_t len)
{
